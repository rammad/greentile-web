...
class GradientEngine {
    ...
    animate() {
        ...
        this.uniforms.uColor1.value.lerp(this.targetColors[0], 0.045);
        this.uniforms.uColor2.value.lerp(this.targetColors[1], 0.045);
        this.uniforms.uColor3.value.lerp(this.targetColors[2], 0.045);
        this.uniforms.uEdgeStrength.value += (this.targetEdgeStrength - this.uniforms.uEdgeStrength.value) * 0.045;
