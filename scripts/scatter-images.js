...
(function () {
    ...
    var DEFAULTS = {
        ...
        // ── section height ─────────────────────────────────────────────────
        slideHeightVhDesktop:   1.4,   // vh per slide — controls total section height (desktop)
        slideHeightVhMobile:    1.0,   // vh per slide — same for mobile

        // ── image sizing — fixed px per breakpoint ──────────────────────
        desktopImages: { front: 200, back: 120 },
        ...
        centerAnchorRef:        1920,  // px — reference viewport width for center-anchored desktop columns
